...
<main class="main-content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="index.php?url=produk/store" enctype="multipart/form-data" class="form-vertical">
                <?= getCSRFField(); ?>
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="harga" min="0" step="0.01" value="<?= e($produk['harga'] ?? ''); ?>" required>
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-cubes"></i> Stok *</label>
                        <input type="number" name="stok" min="0" value="<?= e($produk['stok'] ?? ''); ?>" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
